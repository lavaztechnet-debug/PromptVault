...
const prompts = [
  // ===== APP CATEGORY =====
  { id: 1, category: 'app', icon: '📝', title: 'Offline-First Note App', prompt: 'Build a complete offline-first note app with robust search capabilities, tagging, seamless cloud synchronization, an[...]
  { id: 2, category: 'app', icon: '🎙️', title: 'Premium Podcast Player', prompt: 'Create a premium podcast player featuring advanced playlist management, an intelligent sleep timer, precise chapt[...]
  { id: 3, category: 'app', icon: '👻', title: 'Horror Story Reader', prompt: 'Design an immersive horror story reader app with chilling audio narration, atmospheric visual effects (e.g., subtle par[...]
  { id: 4, category: 'app', icon: '🔐', title: 'Secure Password Vault', prompt: 'Build a highly secure password vault app incorporating biometric authentication (fingerprint/face ID), military-grade[...]
  { id: 5, category: 'app', icon: '🎯', title: 'Habit Tracker Pro', prompt: 'Create a professional habit tracker with advanced streak tracking, customizable reminders, detailed analytics and progres[...]
  { id: 6, category: 'app', icon: '📺', title: 'Media Planner', prompt: 'Build a comprehensive media planner app for content creators, including scriptwriting tools, storyboard creation, publishing [...]
  { id: 7, category: 'app', icon: '💰', title: 'Expense Tracker', prompt: 'Create a fully operational expense tracker with OCR receipt scanning, intelligent categorization, detailed charts and finan[...]
  { id: 8, category: 'app', icon: '📚', title: 'Book Catalog', prompt: 'Build a smart book catalog app with ISBN barcode scanning, automatic metadata retrieval (author, genre, publication date), per[...]
  { id: 9, category: 'app', icon: '👨‍🍳', title: 'Recipe Manager', prompt: 'Create a versatile recipe manager with integrated shopping list generation, robust offline support, a nutritional cal[...]
  { id: 10, category: 'app', icon: '💪', title: 'Fitness Log', prompt: 'Build a comprehensive fitness log app with customizable workout templates, interactive progress graphs, personal record (PR) t[...]
  
  // ===== ANDROID CATEGORY =====
  { id: 11, category: 'android', icon: '🏗️', title: 'Clean Architecture Refactor', prompt: 'Refactor an existing Android application into a modern clean architecture using Jetpack Compose for UI,[...]
  { id: 12, category: 'android', icon: '🔄', title: 'Fragment to Compose Migration', prompt: 'Transform a legacy fragment-based Android application into a modern, declarative Jetpack Compose applica[...]
  { id: 13, category: 'android', icon: '💾', title: 'Offline Caching & Retry Logic', prompt: 'Implement comprehensive offline caching and resilient retry logic within the Android repository layer, e[...]
  { id: 14, category: 'android', icon: '🗄️', title: 'Room Schema Definition', prompt: 'Write a complete Room database schema for an application\'s data model, including detailed Entity definition[...]
  { id: 15, category: 'android', icon: '🧠', title: 'ViewModels for All Screens', prompt: 'Generate robust ViewModels for all application screens, incorporating loading, empty, and error states, alo[...]
  { id: 16, category: 'android', icon: '🗺️', title: 'Navigation Flows', prompt: 'Create comprehensive navigation flows for key user journeys such as onboarding, dashboard, detail views, and setti[...]
  { id: 17, category: 'android', icon: '🌙', title: 'Dark Mode & Accessibility', prompt: 'Add full dark mode support, enhance accessibility features (e.g., content descriptions, touch target sizes),[...]
  { id: 18, category: 'android', icon: '📤', title: 'File Import/Export & Share', prompt: 'Implement secure and user-friendly file import/export functionalities and share intents using Scoped Storag[...]
  { id: 19, category: 'android', icon: '🔁', title: 'Background Sync with WorkManager', prompt: 'Add reliable background data synchronization using WorkManager, implementing battery-friendly schedul[...]
  { id: 20, category: 'android', icon: '🛡️', title: 'App Hardening & Security', prompt: 'Harden an Android application against common vulnerabilities by implementing input sanitization, secure st[...]
  
  // ===== PROMPT CATEGORY =====
  { id: 21, category: 'prompt', icon: '✍️', title: 'Production Gemini Prompt', prompt: 'Rewrite this high-level idea into a production-grade Gemini prompt. The prompt should be highly specific, st[...]
  { id: 22, category: 'prompt', icon: '📋', title: 'One-line to Build Spec', prompt: 'Expand this one-line application concept into a complete build specification document. Include detailed sections[...]
  { id: 23, category: 'prompt', icon: '✂️', title: 'Features to Tasks', prompt: 'Convert a given feature list into a detailed breakdown of implementation tasks, including estimated effort, depende[...]
  { id: 24, category: 'prompt', icon: '💻', title: 'Force Complete Code', prompt: 'Generate a developer prompt that explicitly forces the AI to produce complete, runnable, and non-placeholder code f[...]
  { id: 25, category: 'prompt', icon: '👨‍💼', title: 'Senior Android Architect', prompt: 'Create a prompt making Gemini act as a senior Android architect. The AI should provide expert advice on[...]
  { id: 26, category: 'prompt', icon: '🧪', title: 'Modular Testing', prompt: 'Build a prompt asking for a modular architecture approach with a strong emphasis on testing. The AI should generate cod[...]
  { id: 27, category: 'prompt', icon: '🚀', title: 'Rough Idea to Product', prompt: 'Transform a rough product idea into a deployment-ready product prompt. This includes defining target users, core [...]
  { id: 28, category: 'prompt', icon: '📱', title: 'No Root App Prompt', prompt: 'Create a prompt for building an Android application that operates without requiring root access, avoids hidden depen[...]
  { id: 29, category: 'prompt', icon: '🌐', title: 'Full Stack Prompt', prompt: 'Write a comprehensive prompt generating a full-stack solution, encompassing UI design (frontend), business logic (bac[...]
  { id: 30, category: 'prompt', icon: '🐛', title: 'Code Repair Prompt', prompt: 'Create a prompt making Gemini act as a code repair and improvement agent. The AI should identify bugs, suggest fixes[...]
  
  // ===== DOCUMENT CATEGORY =====
  { id: 31, category: 'document', icon: '📄', title: 'Project Brief', prompt: 'Write a polished project brief for this application. Include an executive summary, a clear problem statement, proposed [...]
  { id: 32, category: 'document', icon: '📋', title: 'PRD Document', prompt: 'Turn a product idea into a comprehensive Product Requirements Document (PRD). Detail user stories, acceptance criteria, [...]
  { id: 33, category: 'document', icon: '🏛️', title: 'Technical Spec', prompt: 'Create a detailed technical specification for an entire Android application. Include an architecture diagram, compo[...]
  { id: 34, category: 'document', icon: '📰', title: 'Release Notes v1.0', prompt: 'Write professional release notes for version 1.0 of an application. Highlight new features, significant improvemen[...]
  { id: 35, category: 'document', icon: '📖', title: 'README Generator', prompt: 'Generate a comprehensive README.md file for a software project. Include sections for setup instructions, features, u[...]
  { id: 36, category: 'document', icon: '🔒', title: 'Privacy Policy', prompt: 'Create a draft privacy policy for a consumer Android application. Address data collection practices, storage, usage, a[...]
  { id: 37, category: 'document', icon: '⚖️', title: 'Terms of Service', prompt: 'Write terms of service for a mobile productivity app. Cover acceptable use, intellectual property, disclaimers, an[...]
  { id: 38, category: 'document', icon: '❓', title: 'Support FAQ', prompt: 'Create a comprehensive support FAQ for an application. Organize by common issues, troubleshooting steps, account managemen[...]
  { id: 39, category: 'document', icon: '📝', title: 'Changelog Template', prompt: 'Write a flexible changelog template for future application updates. Structure it to follow semantic versioning (MA[...]
  { id: 40, category: 'document', icon: '💼', title: 'Investor Summary', prompt: 'Draft a concise one-page investor summary for a mobile product. Articulate the problem, solution, market opportunity[...]
  
  // ===== TOOL CATEGORY =====
  { id: 41, category: 'tool', icon: '🧪', title: 'Test Case Generator', prompt: 'Build a prompt that generates detailed test cases from application requirements or user stories. Include test steps, [...]
  { id: 42, category: 'tool', icon: '🔍', title: 'Code Audit Prompt', prompt: 'Create a prompt for auditing code for potential bugs, missing features, security vulnerabilities, performance bottlenec[...]
  { id: 43, category: 'tool', icon: '🎨', title: 'UI Refactor Prompt', prompt: 'Generate a prompt for refactoring an existing UI into reusable, modular components. Focus on identifying common patter[...]
  { id: 44, category: 'tool', icon: '🌐', title: 'Web to PWA Prompt', prompt: 'Write a prompt for transforming a standard web application into an Android-friendly Progressive Web App (PWA). Include [...]
  { id: 45, category: 'tool', icon: '📊', title: 'Analytics Integration Prompt', prompt: 'Build a prompt for cleanly integrating analytics and event tracking into an application. Specify desired eve[...]
  { id: 46, category: 'tool', icon: '🎯', title: 'Onboarding Flow Generator', prompt: 'Create a prompt that generates engaging onboarding screens and UX copy for a new application. Focus on guiding [...]
  { id: 47, category: 'tool', icon: '🔗', title: 'API Integration Code', prompt: 'Write a prompt producing robust API integration code with built-in error handling, retry mechanisms, and authenticat[...]
  { id: 48, category: 'tool', icon: '💾', title: 'Local-First Storage Strategy', prompt: 'Create a prompt for building a local-first storage strategy for an application. Detail choices between Room,[...]
  { id: 49, category: 'tool', icon: '⚡', title: 'Performance Optimization Prompt', prompt: 'Generate a prompt for performance profiling and optimization of an application. Include steps for identify[...]
  { id: 50, category: 'tool', icon: '✅', title: 'App Launch Checklist', prompt: 'Write a prompt producing a full, detailed app launch checklist. Cover pre-launch marketing, app store submission, and[...]
  
  // ===== IMAGE-ENHANCING CATEGORY =====
  { id: 51, category: 'image-enhancing', icon: '🎨', title: 'Neumorphic UI Design', prompt: 'Design a neumorphic UI mockup with soft, extruded shapes, subtle shadows, and tactile elements. Focus on [...]
  { id: 52, category: 'image-enhancing', icon: '🧊', title: 'Glassmorphism Effect', prompt: 'Create a glassmorphism design with frosted glass effects, translucency, vibrant colors, and layered eleme[...]
  { id: 53, category: 'image-enhancing', icon: '🌐', title: '3D Depth Rendering', prompt: 'Render a 3D depth scene with proper perspective, realistic lighting, accurate shadows, and material propert[...]
  { id: 54, category: 'image-enhancing', icon: '💎', title: 'Premium 3D Material', prompt: 'Create premium 3D materials with realistic reflections, refractions, roughness, and metallic properties. F[...]
  { id: 55, category: 'image-enhancing', icon: '✨', title: 'Luminous 3D Scene', prompt: 'Design a luminous 3D scene with glowing elements, sophisticated lighting design, bloom effects, and atmospher[...]
  { id: 56, category: 'image-enhancing', icon: '🎭', title: 'Surreal 3D Composition', prompt: 'Create a surreal 3D composition with impossible geometry, dramatic lighting, and mind-bending spatial r[...]
  { id: 57, category: 'image-enhancing', icon: '🏛️', title: 'Architectural Visualization', prompt: 'Render architectural visualization with accurate perspective, realistic materials, proper light[...]
  { id: 58, category: 'image-enhancing', icon: '🎬', title: 'Cinematic Poster Grade', prompt: 'Create a cinematic poster grade for an image, applying a dramatic color palette, contrast adjustments, [...]
  { id: 59, category: 'image-enhancing', icon: '💎', title: 'Luxury Product Hero', prompt: 'Render a luxury hero product shot with exquisite lighting, reflective surfaces, and a minimalist backgroun[...]
  { id: 60, category: 'image-enhancing', icon: '👗', title: 'Editorial Fashion Frame', prompt: 'Create an editorial fashion frame for a portrait, emphasizing high contrast, sharp details, and a soph[...]
